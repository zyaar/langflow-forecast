...
def main():
    ...
    print("---------------------------")
    test_range_1 = ForecastMetaDataRange(count = 2,
                                         pred = ["ABC_ID", "XYZ_ID"])
    print(f"{test_range_1}\n\n")
    print(f"{test_range_1.to_json()}\n\n")
    ...
    print("---------------------------------------------------------------")
    test_range_2 = ForecastMetaDataRange(action = ForecastDataSeriesMetaDataAction.PROD,
                                           count = 3,
                                           pred = ["123_ID", "456_ID"])


    test_range_3 = ForecastMetaDataRange(action = ForecastDataSeriesMetaDataAction.PROD,
                                         count = None,
                                         pred = ["123_ID", "456_ID"])
    ...
    test_series_1000 = ForecastMetaDataSeries(id = "123",
                                              ...
                                              ranges = [test_range_1, test_range_2, test_range_3],
                                              data_type = ForecastDataSeriesMetaDataDataType.DATE,
                                              display_type = ForecastDataSeriesMetaDataDataType.DATE,
                                              display_name = "Dates (end-of)",
                                              validation = [{ForecastDataSeriesMetaDataValidationSchema.INPUT_RESTRICTION: ForecastDataSeriesMetaDataValidateInputRestrictions.READ_ONLY}],
